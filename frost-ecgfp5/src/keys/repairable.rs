...
pub fn repair_share_step_2(deltas_j: &[Scalar]) -> Scalar {
    frost::keys::repairable::repair_share_step_2::<EcGFp5Poseidon256>(deltas_j)
}
...
mod tests {
    ...
    fn check_repair_share_step_1() {
        ...
        frost_core::tests::repairable::check_repair_share_step_1::<EcGFp5Poseidon256, _>(rng);
    }
